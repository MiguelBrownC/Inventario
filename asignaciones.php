        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Asignación equipos</h6>
                </nav>
            ...
            <div class="row">
                ...
                foreach ($equipos as $equipo) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-sm"><small><?php echo $equipo["serial_equipo"] ?></small>
                                            </td>
                                            <td class="text-xxs"><small><?php echo $equipo["marca_equipo"] ?></small>
                                            </td>
                                            <td class="text-sm"><small><?php echo $equipo["modelo_equipo"] ?></td>
                                            </small></td>
                                            <td class="text-sm">
                                                <small><?php echo $equipo["procesador_equipo"] ?></small></td>
                                            <td class="text-sm">
                                                <small><?php echo $equipo["capacidad_hdd_equipo"] ?></small></td>
                                            <td class="text-sm"><small><?php echo $equipo["ram_equipo"] ?></small></td>
                                            <td>

                                                <select class="selectpicker" data-live-search="true" id="colaborador">
