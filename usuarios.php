                            ...
                            if($colaborador["equipo_entregado"] == 1 )
                            {
                                ...
                                { 
                                   echo "href='equipo_asignado.php?id=".$colaborador['id_colaborador']."'";
                                     ...
                                     ?> class="btn btn-info" role="button"><i class="fa fa-file-text-o"
                                     ...
                                     ?> class="btn btn-info" role="button"><i class="fa fa-file-text-o"
                                            ...
                                            <td class="align-middle">
                                                <a href="editar.php?id=<?php echo $colaborador["id_colaborador"] ?>"
                                                    class="btn btn-warning" role="button"><i class="fa fa-pencil"
                                                        aria-hidden="true"></i></a>
                                            </td>
                                            <td>
                                                <a href="eliminar.php?id=<?php echo $colaborador["id_colaborador"] ?>"
