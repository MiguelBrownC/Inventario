...
<p class="text-xl-left">Su pérdida o deterioro será sancionado y se descontara cualquier pago que realice la empresa, conforme lo 
  </div>dispone el artículo 58, inciso 2° del código del trabajo.</p>
<hr>

	
	<p style="color:#233f9a;margin-top:-10px">Fecha acta entrega: '.$fecha_asignacion.'</p><p>
