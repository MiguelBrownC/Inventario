...
<!-- Inicio content -->  
 ...
 <hr>
<div class="btn btn-primary"><a href="GenerarPDF.php?id=<?php echo $id; ?>" style="color:#FFF; text-decoration:none; " target="_blank">Visualizar en PDF</a></div>
<div class="btn btn-primary"><a href="DescargarPDF.php?id=<?php echo $id; ?>" style="color:#FFF; text-decoration:none; " target="_blank">Descargar PDF</a></div>
  <hr>
<div class="row">
...
<?php	
	...
	while($transacciones = mysqli_fetch_assoc($resultado_transacciones)){
		echo  '<tr><td>'.$transacciones['id_colaborador'] . "</td>";
		echo  '<td>'.$transacciones['id_colaborador'] . "</td>";
		echo  '<td>'.$transacciones['id_colaborador'] . "</td>";
		echo  '<td>'.$transacciones['id_colaborador'] . "</td>";
		echo  '<td>'.$transacciones['id_colaborador'] . "</td>";
		echo  '<td>'.$transacciones['id_colaborador'] . "</td></tr>";		
	}
