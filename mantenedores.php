...
<head>
    ...
    <title>
        Sistema control inventatio TI MDA
    </title>
    <!--     Fonts and icons     -->
...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="mantenedores.php">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Mantenedores equipos</h6>
                </nav>
        ...
        <div class="container-fluid py-4">
            ...
            <div id="tabs">
                <ul>
                    <li><a href="#tabs-1">Tipo Equipo</a></li>
                    <li><a href="#tabs-2">Marca Equipo</a></li>
                    <li><a href="#tabs-3">Modelo Equipo</a></li>
                </ul>
                            ...
                            <div class="col-12">
                                <div class="card mb-4">
                                    <div class="card-header pb-0">
                                        <h6>Mantenedor modelo equipo</h6>
                                        <a class="btn btn-success my-2"
                                            href="formulario_registrar_modelo_equipo.php">Agregar nuevo modelo</a>
                                    </div>
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-xxs">MODELO EQUIPO</th>
                                                        <th class="text-xxs">EDITAR</th>
                                                        <th class="text-xxs">ELIMINAR</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                 ...
                 foreach ($modelos as $modelo) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="editar_modelo_equipo.php?id=<?php echo $modelo["id_modelo_equipo"] ?>"
                                                                class="btn btn-warning" role="button"><i
                                                                    class="fa fa-pencil" aria-hidden="true"></i></a>
                                                        </td>
                                                        <td>
                                                            <a href="eliminar_modelo_equipo.php?id=<?php echo $modelo["id_modelo_equipo"] ?>"
                ...
                <div id="tabs-1">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card mb-4">
                                <div class="card-header pb-0">
                                    <h6>Mantenedor tipo equipo</h6>
                                    <a class="btn btn-success my-2" href="formulario_registrar_tipo_equipo.php">Agregar
                                        nuevo tipo equipo</a>
                                </div>
                                    ...
                                    <div class="table-responsive p-0">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th class="text-xxs">ID</th>
                                                    <th class="text-xxs">TIPO EQUIPO</th>
                                                    <th class="text-xxs">EDITAR</th>
                                                    <th class="text-xxs">ELIMINAR</th>
                                                </tr>
                                            </thead>
                ...
                foreach ($equipos as $equipo) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="editar_tipo_equipo.php?id=<?php echo $equipo["id_tipo_equipo"] ?>"
                                                            class="btn btn-warning" role="button"><i
                                                                class="fa fa-pencil" aria-hidden="true"></i></a>
                                                    </td>
                                                    <td>
                                                        <a href="eliminar_tipo_equipo.php?id=<?php echo $equipo["id_tipo_equipo"] ?>"
                    ...
                    <div class="container-fluid py-4">
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-4">
                                    <div class="card-header pb-0">
                                        <h6>Mantenedor marca equipo</h6>

                                        <a class="btn btn-success my-2"
                                            href="formulario_registrar_marca_equipo.php">Agregar nuevo tipo marca</a>
                                    </div>
                                    <div class="card-body px-0 pt-0 pb-2">
                                        <div class="table-responsive p-0">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th class="text-xxs">ID</th>
                                                        <th class="text-xxs">MARCA EQUIPO</th>
                                                        <th class="text-xxs">EDITAR</th>
                                                        <th class="text-xxs">ELIMINAR</th>
                                                    </tr>
                                                </thead>
                ...
                foreach ($marcas as $marca) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="editar_marca_equipo.php?id=<?php echo $marca["id_marca_equipo"] ?>"
                                                                class="btn btn-warning" role="button"><i
                                                                    class="fa fa-pencil" aria-hidden="true"></i></a>
                                                        </td>
                                                        <td>
                                                            <a href="eliminar_marca_equipo.php?id=<?php echo $marca["id_marca_equipo"] ?>"
                                                                class="btn btn-danger" role="button"><i
                                                                    class="fa fa-trash" aria-hidden="true"></i></a>
                                                        </td>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            by
                            <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">MDA - Área
                                TI</a>
