        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
            ...
            <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="devoluciones.php">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        ...
                        <h6 class="font-weight-bolder mb-0">Devolución equipo</h6>
                    </nav>
                            ...
                            <div class="card-body px-0 pt-0 pb-2">
                                <div class="table-responsive p-0">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th class="text-xxs">COLABORADOR</th>
                                                <th class="text-xxs">DEVOLUCION</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            foreach ($equipos as $equipo) { ?>
                                                ...
                                                <td class="text-sm">
                                                    <small><?php echo $equipo["nombre_colaborador"] . " " . $equipo["apellido_pat_colaborador"] . " " . $equipo["apellido_mat_colaborador"] ?></small>
                                                </td>
                                                <td class="text-xxs"><small> <a href="devolucioln_equipos.php?id=<?php echo $equipo["id_colaborador"] ?>" class="btn btn-success" role="button"><i class="fa fa-recycle" aria-hidden="true"></i></a></td>
