...
<head>
    ...
    <body>
        ...
        $arquivo = 'Reporte Inventario PCs Estacionarios ' . $dh . '.xls';
...
WHERE e.status_equipo = 1 AND e.id_tipo_equipo = 2
GROUP BY col.rut_colaborador, col.nombre_colaborador, col.apellido_pat_colaborador, e.serial_equipo, m.marca_equipo, mo.modelo_equipo, e.procesador_equipo, e.capacidad_hdd_equipo, e.ram_equipo, e.valor_equipo, e.fecha_compra_equipo 
order by col.nombre_colaborador asc ;";
